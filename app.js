...
const MENU_ITEMS = [
  ...
  },
  {
    ...
    category: "Drinks & Beverages",
    tags: ["Drinks"],
    options: ["Beer - ₦1,200", "Malt - ₦800", "Energy Drink - ₦1,000"],
...
let cart = [];
try {
  cart = JSON.parse(localStorage.getItem("Amala More _cart") || "[]");
} catch (_) {
  cart = [];
}
...
function saveCart() {
  try {
    localStorage.setItem("Amala More _cart", JSON.stringify(cart));
  } catch (_) { }
  updateCartUI();
}
...
function renderHome() {
  ...
  <div class="features">
    <div class="feature-card">
      <div class="feature-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" class="bi bi-stars" viewBox="0 0 16 16" stroke="#fa0f0fe3">
  <path d="M7.657 6.247c.11-.33.576-.33.686 0l.645 1.937a2.89 2.89 0 0 0 1.829 1.828l1.936.645c.33.11.33.576 0 .686l-1.937.645a2.89 2.89 0 0 0-1.828 1.829l-.645 1.936a.361.361 0 0 1-.686 0l-.645-1.937a2.89 2.89 0 0 0-1.828-1.828l-1.937-.645a.361.361 0 0 1 0-.686l1.937-.645a2.89 2.89 0 0 0 1.828-1.828zM3.794 1.148a.217.217 0 0 1 .412 0l.387 1.162c.173.518.579.924 1.097 1.097l1.162.387a.217.217 0 0 1 0 .412l-1.162.387A1.73 1.73 0 0 0 4.593 5.69l-.387 1.162a.217.217 0 0 1-.412 0L3.407 5.69A1.73 1.73 0 0 0 2.31 4.593l-1.162-.387a.217.217 0 0 1 0-.412l1.162-.387A1.73 1.73 0 0 0 3.407 2.31zM10.863.099a.145.145 0 0 1 .274 0l.258.774c.115.346.386.617.732.732l.774.258a.145.145 0 0 1 0 .274l-.774.258a1.16 1.16 0 0 0-.732.732l-.258.774a.145.145 0 0 1-.274 0l-.258-.774a1.16 1.16 0 0 0-.732-.732L9.1 2.137a.145.145 0 0 1 0-.274l.774-.258c.346-.115.617-.386.732-.732z"/></svg>
    ...
    <div class="feature-card">
      <div class="feature-icon">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fa0f0fe3" stroke-width="2"><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83"/><circle cx="12" cy="12" r="3"/></svg>
      </div>
      <h3>Expert Chefs</h3>
    ...
    <div class="feature-card">
      <div class="feature-icon">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fa0f0fe3" stroke-width="2"><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4l3 3v5h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>
      </div>
      <h3>Fast Delivery</h3>
    ...
    <div class="feature-card">
      <div class="feature-icon">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fa0f0fe3" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
      </div>
      <h3>Quick Service</h3>
  ...
  <section class="section">
    ...
    <div class="zones-grid">
      <div class="zone-card"><h3>Trademore/VON/neighbouring estates</h3><div class="fee">₦800</div><div class="eta">ETA: 15–20 mins</div></div>
      <div class="zone-card"><h3>Along the airport road <br> <span style="color:##fa0f0fe3;">Estates</span></h3><div class="fee">₦1,000</div><div class="eta">ETA: 25–30 mins</div></div>
  ...
  <div class="story-section">
    <div class="story-visual">
      <div class="big-logo">Amala<br>Hot</div>
      <div style="color:#fff;text-align:center;font-weight:700;font-size:1.3rem">Amala Hot </div>
    ...
    <div class="story-text">
      <h2>Our Story</h2>
      <div class="underline"></div>
      <p>Amala Hot was born from a passion for authentic Nigerian flavors and a commitment to freshness. Every dish we serve is crafted with care, using locally-sourced ingredients and time-honored recipes.</p>
...
function renderAbout() {
  ...
  <div class="about-story">
    <div>
      <h2>The Amala Hot Story</h2>
      <div class="underline"></div>
      <p>Amala Hot started with a simple belief: everyone deserves access to fresh, delicious, and affordable Nigerian food. Founded in Abuja, we set out to redefine the local food experience with quality ingredients, skilled chefs, and a vibrant dining atmosphere.</p>
      ...
      <p>Today, Amala Hot is more than a restaurant — it's a movement toward healthier eating, stronger communities, and a celebration of Nigerian culinary heritage.</p>
    </div>
  ...
  <section class="values-section">
    ...
    <div class="values-grid">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" class="bi bi-stars" viewBox="0 0 16 16" stroke="#16a34a">
  ...
  <h3>Freshness First</h3><p>We source ingredients locally every morning to guarantee peak freshness in every dish.</p>
      ...
      <div class="value-card"><div class="value-icon"> <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" class="bi bi-stars" viewBox="0 0 16 16" stroke="#16a34a">
  <path d="M7.657 6.247c.11-.33.576-.33.686 0l.645 1.937a2.89 2.89 0 0 0 1.829 1.828l1.936.645c.33.11.33.576 0 .686l-1.937.645a2.89 2.89 0 0 0-1.828 1.829l-.645 1.936a.361.361 0 0 1-.686 0l-.645-1.937a2.89 2.89 0 0 0-1.828-1.828l-1.937-.645a.361.361 0 0 1 0-.686l1.937-.645a2.89 2.89 0 0 0 1.828-1.828zM3.794 1.148a.217.217 0 0 1 .412 0l.387 1.162c.173.518.579.924 1.097 1.097l1.162.387a.217.217 0 0 1 0 .412l-1.162.387A1.73 1.73 0 0 0 4.593 5.69l-.387 1.162a.217.217 0 0 1-.412 0L3.407 5.69A1.73 1.73 0 0 0 2.31 4.593l-1.162-.387a.217.217 0 0 1 0-.412l1.162-.387A1.73 1.73 0 0 0 3.407 2.31zM10.863.099a.145.145 0 0 1 .274 0l.258.774c.115.346.386.617.732.732l.774.258a.145.145 0 0 1 0 .274l-.774.258a1.16 1.16 0 0 0-.732.732l-.258.774a.145.145 0 0 1-.274 0l-.258-.774a1.16 1.16 0 0 0-.732-.732L9.1 2.137a.145.145 0 0 1 0-.274l.774-.258c.346-.115.617-.386.732-.732z"/>
  </svg>
  ...
  <div class="brand-identity">
    ...
    <div class="underline"></div>
    <p>The Amala Hot logo combines the letters F and B with a leaf, symbolizing freshness and natural ingredients.</p>
  </div>`;
}
...
function renderContact() {
  ...
  <div class="contact-section">
    <div class="contact-info">
      ...
      <div><h4>Address</h4><p>VON Garden city estate, Lugbe, Abuja, Nigeria</p></div></div>
      <div class="info-item">
      <div class="info-icon">
      ...
      </div><div><h4>Email</h4><p>hello@AmalaHot.ng</p></div></div>
      <div class="info-item"><div class="info-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-alarm-fill" viewBox="0 0 16 16">
  <path d="M6 .5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1H9v1.07a7.001 7.001 0 0 1 3.274 12.474l.601.602a.5.5 0 0 1-.707.708l-.746-.746A6.97 6.97 0 0 1 8 16a6.97 6.97 0 0 1-3.422-.892l-.746.746a.5.5 0 0 1-.707-.708l.602-.602A7.001 7.001 0 0 1 7 2.07V1h-.5A.5.5 0 0 1 6 .5m2.5 5a.5.5 0 0 0-1 0v3.362l-1.429 2.38a.5.5 0 1 0 .858.515l1.5-2.5A.5.5 0 0 0 8.5 9zM.86 5.387A2.5 2.5 0 1 1 4.387 1.86 8.04 8.04 0 0 0 .86 5.387M11.613 1.86a2.5 2.5 0 1 1 3.527 3.527 8.04 8.04 0 0 0-3.527-3.527"/>
</svg>
      </div><div><h4>Hours</h4><p>Mon–Fri 7am–10pm | Sat 8am–11pm | Sun 9am–9pm</p></div></div>
    </div>
